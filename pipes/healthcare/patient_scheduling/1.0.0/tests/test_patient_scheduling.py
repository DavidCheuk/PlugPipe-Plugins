...
"""
Test Suite for Patient Scheduling Pipe
...
class TestPatientschedulingPipe:
    """Test suite for patient_scheduling pipe"""
    ...
    @pytest.mark.parametrize("step_name", ['"appointment_request"', '"availability_check"', '"confirmation"', '"reminder_notifications"', '"check_in"'])
    ...
    def test_documentation_references(self):
        ...
        assert 'patient_scheduling' in content.lower()
