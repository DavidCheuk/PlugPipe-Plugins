...
"""
Test Suite for Demo Customer Support Pipe
...
class TestDemocustomersupportPipe:
    """Test suite for demo_customer_support pipe"""
    ...
    def test_pipe_spec_structure(self):
        ...
        assert len(self.pipe_spec['pipeline']) == 1
    ...
    @pytest.mark.parametrize("step_name", ['"notification"'])
    ...
    def test_documentation_references(self):
        ...
        assert 'demo_customer_support' in content.lower()
