...
from main import process, Test_FixApiClient


class TestTestFixApiPlugin:
    """Test suite for test_fix_api plugin"""
    ...
    def test_client_initialization(self):
        ...
        client = Test_FixApiClient(self.config, Mock())

        assert client.base_url == 'https://jsonplaceholder.typicode.com'
        assert 'test-key' in str(client.session.headers.get('Authorization', ''))
