...
def process(context: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if operation == "analyze_file":
            ...
            # Default operation - show status and capabilities
            return {
                "success": True,
                "operation": "analyze",
                "message": "Error Handling Analyzer is operational",
                "plugin": "error_handling_analyzer",
                "version": "1.0.0",
                "capabilities": [
                    "analyze_file",
                ...
                "info": "Provide operation parameter to specify analysis type"
            }
            ...
            return {
                ...
                "supported_operations": ["analyze", "analyze_file", "analyze_directory", "apply_fixes", "get_status"]
            }
